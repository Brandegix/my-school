    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white overflow-x-hidden">
      ...
      <section className="max-w-5xl mx-auto px-4 py-20 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-6 mt-8">
          {stats.map((stat, i) => (
            <div key={i} className="flex flex-col items-center bg-white/10 rounded-xl px-8 py-6 min-w-[150px] shadow-lg">
      ...
      <section className="max-w-5xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {team.map((member, i) => (
            <div key={i} className="bg-white/10 rounded-xl p-6 flex flex-col items-center text-center shadow-lg">
      ...
      <section className="max-w-3xl mx-auto px-4 py-16 text-center">
        <div className="bg-gradient-to-r from-purple-500 via-pink-500 to-blue-500 rounded-2xl p-10 shadow-xl">
